...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("arka_tagline", "IT & Cybersecurity Solutions"),
        ("arka_about_desc", "Rayan Samaneh Arka provides professional IT infrastructure, cybersecurity, software, and technical support services for organizations. This client is provided for secure remote technical support and assistance by Arka specialists."),
        ("desk_tip", "Your desktop can be accessed with this ID and password."),
        ("connecting_status", "Connecting to the Arka network..."),
        ...
        ("Slogan_tip", "For technical assistance, please contact Arka Support."),
        ...
        ("install_tip", "Due to UAC, Arka can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Arka to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Arka \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Arka \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Arka to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Arka Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Arka application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Arka \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Arka \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Arka."),
        ...
        ("verify_rustdesk_password_tip", "Verify Arka password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Arka and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Arka Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Arka from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Arka window is open"),
        ...
        ("floating_window_tip", "It helps to keep Arka background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Arka client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Arka verifies the server certificate for protocols using TLS.\nWith this option enabled, Arka will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Arka will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Arka server OSS doesn't include this feature."),
